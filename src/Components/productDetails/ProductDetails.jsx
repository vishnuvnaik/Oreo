      ...
      <div style={{ height: "100%" }}>
        <div className="containerDetails">
          <div className="columnWise">
            <div>
              <img src={this.state.currentProduct.img} className="bigimg" />
            </div>
            <div className="mapDiv">
              {productdata.Products.map((data, index) => (
                <div
                  key={data.id}
                  onClick={() => this.imageButton(data.img, data.id, index)}
                >
          ...
          <div className="sideRow">
            ...
            <div className="reviews">
              <ReactStars size={20} name="rate1" count={5} value={3.5} />
        ...
        <div className="productItemdetails2">
          {this.state.displayCard === "description" ? (
            ...
            <div className="description">
              ...
              type and scrambled it to make a type specimen book. There are many
